    ...
    <CardN>
      ...
      <CardFooter className="flex justify-center">
        <p className="text-md rounded-full px-5 py-3 font-bold flex gap-2 justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill="none" stroke-width="1.4" viewBox="0 0 24 24" color="#0d0c0d"><path stroke="#0d0c0d" stroke-width="1.4" d="M20 10c0 4.418-8 12-8 12s-8-7.582-8-12a8 8 0 1 1 16 0Z"></path><path fill="#0d0c0d" stroke="#0d0c0d" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" d="M12 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"></path></svg>
          {adresse}
        </p>
      </CardFooter>
    </CardN>
    ...
    <Layout
      header={<div className="h-[500px] overflow-hidden relative bg-black" >
        ...
        {/* <div className={`top-[200px] absolute rounded-full overflow-hidden blue mx-[40%] w-content flex flex-row bg-white pl-8 h-120px items-center justify-center`}>
          <svg width="20px" height="20px" viewBox="0 0 24 24" stroke-width="1.4" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ccc">
              <path d="M17 17l4 4M3 11a8 8 0 1016 0 8 8 0 00-16 0z" stroke="#ccc" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>
        ...
        */}
        ...
        <div className="mb-4 flex flex-col gap-4">
          <div className="flex gap-4 justify-center">
            <svg width="32px" stroke-width="1.4" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#fb6a09"><path d="M4 19V5a2 2 0 012-2h13.4a.6.6 0 01.6.6v13.114" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round"></path><path d="M8 3v8l2.5-1.6L13 11V3" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M6 17h14M6 21h14" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round"></path><path d="M6 21a2 2 0 110-4" stroke="#fb6a09" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path></svg>
