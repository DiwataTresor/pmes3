...
const page=()=>{
  ...
  return (
    ...
    <LayoutDashboardMain showNavigation navigationBar="Information">
            <LayoutDashboard titre="Statistique visite de votre site web" titreIcone={<LineChartOutlined twoToneColor="#eb2f96" style={{fontSize:30}} />}>
               
                    <div className={ " flex flex-col gap-4 items-center justify-center"}>
                        <div className="flex flex-row gap-3">
                               <span>Vus du jour </span>
                               {/* <span>Vus du jour : {profil.typecompte==="E"?"Entreprise":"Personnel"}</span> */}
                               <Badge content="05" shape="circle" color="danger">
                                    <Button
                                      radius="full"
                                      isIconOnly
