...
import {capitalize} from "@/app/fcts/helper";
...
export default function App({columns,showStatus,INITIAL_VISIBLE_COLUMNS,datas,emptyMsg,cellule,coloneSearch, handleBtnNouveau,btnnouveauText,hideBtnNouveau}) {
  ...
  return (
    ...
    >
      ...
      <TableBody emptyContent={emptyMsg || "Aucune donnée trouvée"} items={sortedItems}>
        {(item) => (
