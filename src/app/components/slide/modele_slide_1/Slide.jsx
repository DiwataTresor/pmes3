                                         ...
                                         <>
                                            ...
                                            >
                                                ...
                                                <div className='absolute right-3 top-3 flex flex-col items-start justify-start w-[700px] pt-[100px] text-white'>
                                                    ...
                                                    }}>{slide1Elt?.text?.txt1?.content}</p></Fade>
                            ...
                            <Spin spinning={spinning}>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        <div
                                            className='relative border overflow-hidden rounded-md h-[250px] lg:h-[400px] w-full m-3 bg-cover backdrop-blur-lg'
                                            style={{
                                                backgroundImage:
                                                    `url(
                                                        ${(newBg.startsWith("images"))
                                        ...
                                        >
                                            ...
                                            <div className='h-[200px] lg:h-[400px] w-[200px] lg:w-[300px] top-5 absolute left-3'>
                                                <Image src={imgUser ?? user1} fill />
                                                {mode == "edition" && <Button
                                                    className='mt-[40%]'
                                                    onClick={() => { edit({ id: "user", lien: slide1Elt?.background, type: "img" }) }}
                                            ...
                                            <div className='absolute right-3 top-3 flex flex-col gap-4 lg:gap-7 items-start justify-start w-[250px] lg:w-[700px] pt-[20px] lg:pt-[100px] text-white'>
                                                <p onClick={() => {

                                                    mode == "edition" && edit({ id: "txt1", textContent: slide1Elt?.text?.txt1?.content, type: "text" })
                                                }}>{slide1Elt?.text?.txt1?.content}</p>
                                                <p className=' text-3xl lg:text-[50px] font-bold text-white text-left flex-wrap' onClick={() => {
                            ...
                            <Spin spinning={spinning}>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        <div
                                            className='relative border rounded-md h-[250px] lg:h-[400px] w-full m-3 bg-cover backdrop-blur-lg'
                                            style={{
                                                backgroundImage:
                                                    `url(
                                                        ${(newBg.startsWith("images"))
                                        ...
                                        >
                                            ...
                                            <div className='h-[200px] lg:h-[400px] w-[200px] top-5 lg:w-[300px] absolute right-3'>
                                                <Image src={imgUser ?? user1} fill />
                                                {mode == "edition" && <Button
                                                    className='mt-[40%]'
                                                    onClick={() => { edit({ id: "user", lien: slide1Elt?.background, type: "img" }) }}
                                            ...
                                            <div className='absolute left-3 gap-4 lg:gap-7 justify-center top-3 flex flex-col items-start w-[250px] lg:w-[700px] pt-[40px] lg:pt-[100px] text-white'>
                                                <p onClick={() => {

                                                    mode == "edition" && edit({ id: "txt1", textContent: slide1Elt?.text?.txt1?.content, type: "text" })
                                                }}>{slide1Elt?.text?.txt1?.content}</p>
                                                <p className='text-2xl lg:text-[50px] font-bold text-white text-left flex-wrap' onClick={() => {
                            ...
                            <Spin spinning={spinning}>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex flex-col gap-3 pr-3'>
                                        ...
                                        <div
                                            className='relative border rounded-md overflow-hidden h-[250px] lg:h-[400px] w-full m-3 bg-cover backdrop-blur-lg'
                                            style={{
                                                backgroundImage:
                                                    `url(
                                                        ${(newBg.startsWith("images"))
                                        ...
                                        >
                                            ...
                                            <div className=' top-3 flex flex-col gap-5 items-center justify-center w-full pt-[40px] lg:pt-[100px] text-white'>
                                                <p onClick={() => {

                                                    mode == "edition" && edit({ id: "txt1", textContent: slide1Elt?.text?.txt1?.content, type: "text" })
                                                }}>{slide1Elt?.text?.txt1?.content}</p>
                                                <p className='text-2xl lg:text-[50px] font-bold text-white text-center flex-wrap' onClick={() => {
